...
import { MedalSystem } from './medalSystem.js';
...
export class GameRefactored {
  constructor(canvasId, selectedCharacterId = 0, pauseCallback = () => {}, gameOverCallback = () => {}) {
    ...
    // Initialize character and player
    const character = characters.find(c => c.id === selectedCharacterId) || characters[0];
    this.selectedCharacterId = character.id;

    // Initialize core game objects
    this.player = new Player(100, 100, 64, 64, character.sprite, () => this.onPlayerDeath());
  ...
  _initializeManagers() {
    ...
    // Entity Manager
    this.entityManager = new EntityManager(this.world, this.player);
